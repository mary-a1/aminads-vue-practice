...
<template>
  <article class="project-card">
    <div class="card-top">
      ...
      <div class="meta-tags">
        <span class="pill pill-primary">Live SaaS UI</span>
        <span class="pill pill-soft">Shipped experience</span>
      </div>
    </div>
...
<style scoped>
  /* ===== BASE ===== */
  .project-card {
    background: linear-gradient(145deg, #0f172a, #111827 35%, #0b1020);
  ...
  .cta:hover {
    ...
    box-shadow: 0 16px 35px rgba(96, 165, 250, 0.45);
  }
